...
<?php
include("db.php");
$sql = "SELECT * FROM sube INNER JOIN personel ON sube.sube_ID = personel.sube_ID WHERE sube.sube_ID =7 ORDER BY personel_gorev";
...
<div> <?php
include("db.php");
$sql = "SELECT * FROM sube INNER JOIN satis ON satis.sube_ID = sube.sube_ID WHERE sube.sube_ID = 7";
$result = mysqli_query($conn, $sql);
mysqli_close($conn);
...
<?php
include("db.php");
$sql = "SELECT * FROM sube INNER JOIN yemek_sepeti_puan ON yemek_sepeti_puan.sube_ID = sube.sube_ID WHERE sube.sube_ID = 7";
$result = mysqli_query($conn, $sql);
mysqli_close($conn);
